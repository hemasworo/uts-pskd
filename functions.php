...
function registrasi($data) {
	...
	$result = mysqli_query($conn, "SELECT FROM user WHERE username = '$username'and password = '$password_md5'");
	...
	mysqli_query($conn, "INSERT INTO user VALUES('$username', '$password_md5', '$email', '$name_lengkap')");
